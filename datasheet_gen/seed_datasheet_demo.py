...
Usage (inside the web container):
    docker compose exec web python datasheet_gen/seed_datasheet_demo.py
    docker compose exec web python datasheet_gen/seed_datasheet_demo.py --reset   # rebuild demo data
